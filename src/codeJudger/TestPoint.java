...
public class TestPoint {
	...
	/**
	 * 通过时间限制，内存限制，测试点分值，答案比较方式构造测试点对象
	 * 
	 * @param Time_Limit
	 *            时间限制
	 * @param Memory_Limit
	 ...
	 *            答案比较方式
	 */
	public TestPoint(long Time_Limit, long Memory_Limit, long Score, int JudgeMod) {
		this.JudgeMod = JudgeMod;
	 ...
	 *            输入文件位置
	 */
	public TestPoint(long Time_Limit, long Memory_Limit, long Score, int JudgeMod, String Test_In) {
		this.JudgeMod = JudgeMod;
		this.Time_Limit = Time_Limit;
		this.Memory_Limit = Memory_Limit;
		this.Score = Score;
